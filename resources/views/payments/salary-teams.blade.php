    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Salary Payments</h2>
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <a href="{{ route('payments.salary.team', $team->id) }}" class="block bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition-shadow duration-200 p-6">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">{{ $team->name }}</h3>
                            <div class="space-y-2">
