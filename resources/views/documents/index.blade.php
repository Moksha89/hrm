    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="mb-6">
                    <p class="text-gray-600 dark:text-gray-400">Select a team to view employee documents</p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @forelse($teams as $team)
                    <a href="{{ route('documents.team', $team->id) }}" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 hover:shadow-lg transition-all hover:scale-105 cursor-pointer">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ $team->employees_count }} {{ $team->employees_count == 1 ? 'Employee' : 'Employees' }}</p>
                                </div>
                            </div>
                    ...
                    <div class="col-span-full text-center py-12">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating a team.</p>
                    </div>
                    @endforelse
                </div>
            </main>
